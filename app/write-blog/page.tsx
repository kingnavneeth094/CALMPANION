        ...
        <section className="pt-32 pb-16 px-4">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Your experiences and insights can help others on their mental
              health journey.
            </p>
          </div>
        </section>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-muted/50 p-4 rounded-lg">
                  ...
                  <ul className="text-sm text-muted-foreground space-y-2">
                    ...
                    <li>
                      • Include trigger warnings when discussing sensitive
                      topics
                    </li>
                    <li>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Share your genuine experiences and emotions. Your authenticity
                  helps others relate to your story.
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-semibold mb-4">Stay Focused</h3>
                <p className="text-muted-foreground">
                  Keep your writing clear and focused on one main topic. This
                  helps readers better understand your message.
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-sm">
                <h3 className="text-xl font-semibold mb-4">Offer Hope</h3>
                <p className="text-muted-foreground">
                  While sharing challenges, include positive insights or lessons
                  learned to inspire and encourage others.
                </p>
              </div>
            </div>
          </div>
