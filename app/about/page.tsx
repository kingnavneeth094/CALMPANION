        ...
        <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-orange-50 to-white dark:from-orange-950 dark:to-background">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              ...
              compassionate support and innovative solutions.
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  At Calmpanion, we believe that everyone deserves access to
                  quality mental health support. Our mission is to break down
                  barriers to mental healthcare and create a supportive
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Providing empathetic support to every individual
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Creating a secure environment for healing and growth
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground">
                        Building connections that foster understanding
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-card p-6 rounded-xl shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Committed to providing the highest quality mental health
              ...
              <div className="bg-card p-6 rounded-xl shadow-sm">
                ...
                <p className="text-muted-foreground">
                  Making mental health support available to everyone,
                  everywhere.
                </p>
              </div>
              <div className="bg-card p-6 rounded-xl shadow-sm">
