...
const BLOG_POSTS = [
  {
    ...
    content:
      "Anxiety is a natural response to stress, but when it becomes overwhelming, it can affect our daily lives...",
  ...
  },
  {
    ...
    content:
      "Three years ago, I found myself at a crossroads. The pressure of work, relationships, and personal expectations had taken its toll...",
  ...
  },
  {
    ...
    content:
      "Recent studies have shown that regular meditation practice can have significant positive effects on mental health...",
      ...
      <main className="flex-grow">
        ...
        <section className="pt-32 pb-16 px-4 bg-gradient-to-b from-orange-50 to-white dark:from-orange-950 dark:to-background">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="text-5xl font-bold mb-6">Mental Health Blog</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Explore insights, stories, and expert advice from our community of
